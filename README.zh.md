...
| Vendor/Implementation | Control Plane | Echo Mode | Demand Mode | Multihop | Authentication |
|----------------------|---------------|-----------|-------------|----------|----------------|
| FRRouting 9.0        | ✅           | ✅        | ✅          | ✅       | ✅ MD5/SHA1   |
| Cisco IOS XE 17.x    | ✅           | ✅        | ✅          | ✅       | ✅ Password   |
| Nokia SR OS          | ✅           | ⏳        | ⏳          | ⏳       | ⏳             |

**Test Environment:** Debian13, Kernel 6.12
**Latest Test Date:** July 2026